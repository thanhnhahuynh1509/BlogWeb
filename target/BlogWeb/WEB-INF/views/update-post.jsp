...
<body>
    ...
    <form:form action="processFormUpdate" autocomplete="off" modelAttribute="postUpdate" method="post">
        <form:input path="id" readonly="true" class="input" cssStyle="display: none"/>
        ...
        <a href="/post/delete?id=${postUpdate.id}" onclick="return confirm('Bạn có chắc chắn muốn xóa bài viết?')" style="background-color: #f35656" class="btn-delete">Xóa</a>
        <input type="submit" style="background-color: #ced029" value="Cập nhật" class="btn-submit">
    </form:form>
